...
Usuario.init({
    ...
    numeroTelefono:{type:DataTypes.DECIMAL (10,0), allowNull:true},
    ...
    genero:{type:ENUM('masculino','femenino','otro'), allowNull:true},
    ...
    pais:{type: DataTypes.STRING (200), allowNull:true},
